...
{
	public partial class SilverSponsorsPage : ContentPage
	{
		public SilverSponsorsPage()
		{
			InitializeComponent();
			...
			if (allSponsors != null)
			{
				lstSponsorDetails.ItemsSource = allSponsors.
												Where(s => s.SponsorLevel.Equals("Silver", StringComparison.CurrentCultureIgnoreCase)).
